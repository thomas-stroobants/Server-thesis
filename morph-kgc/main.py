...
# get_gtfs_rt_lijn()
# get_gtfs_rf_nmbs()
get_gtfs_rt(de_lijn_rt_url, "de-lijn-data/de-lijn-rt-gtfs-staking2.json", params=params, headers=headers)
get_gtfs_rt(nmbs_rt_url, "nmbs-rt-data/nmbs-rt-gtfs-staking2.json")