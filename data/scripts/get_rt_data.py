...
# get_gtfs_rt_lijn()
# get_gtfs_rf_nmbs()
get_gtfs_rt(de_lijn_rt_url, f"./data/de-lijn-rt-data/de-lijn-rt-gtfs2-{time.time()}.json", params=params, headers=headers)
get_gtfs_rt(de_lijn_rt1_url, f"./data/de-lijn-rt-data/de-lijn-rt-gtfs1-{time.time()}.json", headers=headers)
get_gtfs_rt(nmbs_rt_url, f"./data/nmbs-rt-data/nmbs-rt-gtfs-{time.time()}.json")
# get_gtfs_rt_lijn()