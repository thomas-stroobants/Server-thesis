...
function download_data() {
    curl -o "./data/" https://gtfs.irail.be/de-lijn/de_lijn-gtfs.zip
    curl -o "./data/" https://gtfs.irail.be/mivb/mivb-gtfs.zip
    curl -o "./data/nmbs-gtfs.zip" https://sncb-opendata.hafas.de/gtfs/static/c21ac6758dd25af84cca5b707f3cb3de 
    curl -o "./data/" https://gtfs.irail.be/tec/tec-gtfs.zip
