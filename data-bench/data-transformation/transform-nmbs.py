...
with open(f'{Path.home()}/data-bench/nmbs-rt-data/nmbs-rt-gtfs.json') as sfile:
...
with open(f'{Path.home()}/data-bench/nmbs-rt-data/nmbs-rt-gtfs-adap.json', 'w') as ofile:
