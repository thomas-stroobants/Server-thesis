...
calendar_dates_df = pd.read_csv('/home/thomas/data-bench/nmbs-gtfs/calendar_dates.csv')
...
merged_tripid_df.to_csv('/home/thomas/data-bench/nmbs-gtfs/stop_times.csv', index=False)